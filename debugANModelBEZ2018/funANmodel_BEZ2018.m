...
vihc = ANModelBEZ2018.model_IHC_BEZ2018(stim,CF_Hz,1,dt,1.05*T,cohc,cihc,species);

spikes_trains= cell(nrep, 1);
for repVar= 1:nrep
    [psth,meanrate, varrate, synout, trd_vector,trel_vector] = ANModelBEZ2018.model_Synapse_BEZ2018(vihc,CF_Hz,1,dt,noiseType,implnt,spont,tabs,trel);
    spikes_trains{repVar}= find(psth)'/Fs_AN;
end
